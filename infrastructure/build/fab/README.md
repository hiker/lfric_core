...
configuration file (e.g. from ```nci_gadi/config.py```). This an act as a template
...
If you don't have specified a default compiler suite in your site-specific setup (or
